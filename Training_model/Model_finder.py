...
class Best_model_finder:
    ...
    def linearregression(self):
        ...
        return r2_score(self.y_test, Y_predicted),self.linearregression
    ...
    def random_forest_regression(self):
        ...
        return r2_score(self.y_test, y_predict), self.random_forest_regression

    def decision_tree_regression(self):
        DTree = DecisionTreeRegressor(min_samples_leaf=.0001)
        DTree.fit(self.X_train, self.Y_train)
        y_predict = DTree.predict(self.X_test)
        return r2_score(self.y_test, y_predict), self.decision_tree_regression
    ...
    def extra_tree_regression(self):
        ...
        return r2_score(self.y_test, y_predict), self.extra_tree_regression
